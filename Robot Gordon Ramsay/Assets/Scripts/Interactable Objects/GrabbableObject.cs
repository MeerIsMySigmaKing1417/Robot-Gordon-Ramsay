...
public class GrabbableObject : MonoBehaviour
{
    ...
    [Tooltip("Custom color for the grab line (leave default for weight-based color)")]
    public Color customLineColor = Color.clear;
    [Tooltip("Custom line width (0 = use weight-based width)")]
...
public static class WeightUtility
{
    ...
    public static Color GetWeightColor(ObjectWeight weight)
    {
        switch (weight)
        {
            case ObjectWeight.VeryLight: return Color.white;
            case ObjectWeight.Light: return Color.green;
            case ObjectWeight.Medium: return Color.cyan;
            case ObjectWeight.Heavy: return Color.yellow;
            case ObjectWeight.VeryHeavy: return Color.red;
            default: return Color.gray;
        }
    }
    
    public static float GetLineWidth(ObjectWeight weight)
    {
        switch (weight)
        {
            case ObjectWeight.VeryLight: return 0.02f;
            case ObjectWeight.Light: return 0.03f;
            case ObjectWeight.Medium: return 0.05f;
            case ObjectWeight.Heavy: return 0.07f;
            case ObjectWeight.VeryHeavy: return 0.09f;
